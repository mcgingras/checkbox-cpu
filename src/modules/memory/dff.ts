...
// I'm having a hard time implementing the DFF out of my gates because the input relies on the output in a cyclical way that is hard to model. So, this "cheat" DFF won't actually be built out of NAND gates but will just be a passthrough layer that takes inputs and outputs and follows the DFF interface.
const dffCheat = (
  input: HTMLInputElement,
  clk: HTMLInputElement,
  label?: string
